...
-- NUMBER 6
UPDATE borrows
SET id = RIGHT(id,1); -- Cut the substring FROM the RIGHT BY 1 character
...
DELETE FROM borrows; -- This will also DELETE the DATA FROM books_borrows
...
('2024-07-14' ,'2024-07-29' ,'2024-05-28', 5000.00 ,'3525017006950028' ,'EM001'),
('2024-09-22','2024-10-8' ,'2024-10-6', 10000.00 ,'3525017006520020' ,'EM003'),
...
FROM employees
WHERE name = 'Alexander Agus';

UPDATE Books
SET STOCK = STOCK-1
WHERE title = "Complete Dictionary OF Information Technology Terms";

INSERT INTO books_borrows VALUES ('BK003',6);
